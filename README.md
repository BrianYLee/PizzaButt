...
This is a really bad example of what it is: an online ordering system, however it's a good example of what a full stack project looks like at its most basic level using angular.

## In case you've never used Angular

Angular is built with TypeScript. Only modify `.ts` files, as any change in `.ts` files will generate a corresponding javascript `.js` file. Don't modify `.js` files directly unless you know what you're doing.
...
## Starting server and angular server
